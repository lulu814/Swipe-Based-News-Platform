...
public class HomeFragment extends Fragment implements TinNewsCard.OnSwipeListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // 监听user点击,callback  OnClickListener interface 匿名类
        //homefragment --> OnClickListener, event: click/swipe
...
//        });
        ...
        // lifecycle
        // ViewModelProvider --> NewsViewModelFactory help retain the view model we created, so that it can be restored even if it is got deleted due to lifecycle
